...
@Component({
  selector: 'CircuitWeather-home',
  templateUrl: './CircuitWeather-home.component.html',
  styleUrls: ['./CircuitWeather-home.component.scss']
})
export class CircuitWeatherHomeComponent implements AfterViewInit {
