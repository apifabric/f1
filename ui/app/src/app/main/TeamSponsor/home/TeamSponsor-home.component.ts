...
@Component({
  selector: 'TeamSponsor-home',
  templateUrl: './TeamSponsor-home.component.html',
  styleUrls: ['./TeamSponsor-home.component.scss']
})
export class TeamSponsorHomeComponent implements AfterViewInit {
