...
@Component({
  selector: 'LapTime-home',
  templateUrl: './LapTime-home.component.html',
  styleUrls: ['./LapTime-home.component.scss']
})
export class LapTimeHomeComponent implements AfterViewInit {
