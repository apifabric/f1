...
@Component({
  selector: 'RaceResult-home',
  templateUrl: './RaceResult-home.component.html',
  styleUrls: ['./RaceResult-home.component.scss']
})
export class RaceResultHomeComponent implements AfterViewInit {
