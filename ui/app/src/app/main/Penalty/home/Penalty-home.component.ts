...
@Component({
  selector: 'Penalty-home',
  templateUrl: './Penalty-home.component.html',
  styleUrls: ['./Penalty-home.component.scss']
})
export class PenaltyHomeComponent implements AfterViewInit {
